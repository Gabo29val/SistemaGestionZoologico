...
<head>
    ...
    <title>Agregar ticket extranjero - Sistema de Gestión de Zoológico</title>
                    ...
                    <div class="col-lg-12 col-ml-12">
                        <div class="row">
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Agregar ticket extranjero</h4>


                                        <form method="post" action="" name="">
                                             <div class="form-group">
                                                <label for="exampleInputEmail1">Adulto</label>
                                                <input type="text" class="form-control" id="noadult" name="noadult" aria-describedby="emailHelp" placeholder="No. de adultos" value="" required="true">
                                            </div>
                                         <div class="form-group">
                                                <label for="exampleInputEmail1">Niño</label>
                                                <input type="text" class="form-control" id="nochildren" name="nochildren" aria-describedby="emailHelp" placeholder="No. de niños" value="" required="true">
...
?>
                                      ...
                                      <?php } ?>
                                            <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4" name="submit">Generar</button>
                                        </form>
                                    </div>
                                </div>
                            </div>

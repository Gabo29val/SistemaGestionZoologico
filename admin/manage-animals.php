...
?>
    ...
    <head>
        ...
        <title>Gestionar animales - Sistema de Gestión de Zoológico</title>
                ...
                <div class="main-content-inner">
                    <div class="row">
                        ...
                        <div class="col-12 mt-5">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title">Gestionar animales</h4>
                                                        ...
                                                        <td>
                                                            <div class="container-botones">
                                                                <div class="btn-editar">
                                                                    <a href="edit-animal-details.php?editid=<?php echo $row['ID']; ?>">
                                                                        <ion-icon name="pencil-outline"></ion-icon>Editar
                                                                    </a>
                                                                </div>
                                                                <div class="btn-eliminar">
                                                                    <a href="eliminar-animal.php?editid=<?php echo $row['ID']; ?>" onClick="return confirmDelete()">

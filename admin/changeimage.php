...
<head>
    ...
    <title>Cambiar imagen del animal - Sistema de Gestión de Zoológico</title>
...
?>
                                             <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="aname" name="aname" aria-describedby="emailHelp" placeholder="Ingrese nombre del animal" value="<?php  echo $row['AnimalName'];?>" readonly="true">
                                            </div>
                                       
                                           <div class="form-group">
                                                <label for="exampleInputEmail1">Antigua imagen del animal</label>
                                                <img src="images/<?php  echo $row['AnimalImage'];?>" width="100" height="100">
                                            </div>
                                          <div class="form-group">
                                                <label for="exampleInputEmail1">Nueva imagen del animal</label>

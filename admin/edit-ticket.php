...
<head>
    ...
    <title>Actualizar precio del ticket - Sistema de Gestión de Zoológico</title>
                    ...
                    <div class="col-lg-12 col-ml-12">
                        <div class="row">
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Actualizar precio del ticket</h4>
...
?>
                                         ...
                                         <div class="form-group">
                                                <label for="exampleInputEmail1">Costo del ticket</label>

...
?>
    ...
    <head>
        ...
        <title>Sistema de Gestión de Zoológico|| Dashboard</title>
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                ...
                <div class="main-content-inner">
                                ...
                                <div class="single-report">
                                    <div class="s-sale-inner pt--30 mb-3">
                                        <div class="s-report-title d-flex justify-content-between">
                                            ...
                                            ?>
                                            <h3 class="header-title mb-0">Hoy visitante normal adulto</h3>
                                ...
                                <div class="single-report">
                                    <div class="s-sale-inner pt--30 mb-3">
                                        <div class="s-report-title d-flex justify-content-between">
                                            ...
                                            ?>
                                            <h4 class="header-title mb-0">Hoy visitante normal niño</h4>
                                ...
                                <div class="single-report">
                                    <div class="s-sale-inner pt--30 mb-3">
                                        <div class="s-report-title d-flex justify-content-between">
                                            ...
                                            ?>
                                            <h4 class="header-title mb-0">Ayer visitante normal adulto</h4>
                                ...
                                <div class="single-report">
                                    <div class="s-sale-inner pt--30 mb-3">
                                        <div class="s-report-title d-flex justify-content-between">
                                            ...
                                            ?>
                                            <h4 class="header-title mb-0">Ayer visitante normal niño</h4>
                                ...
                                <div class="single-report">
                                    <div class="s-sale-inner pt--30 mb-3">
                                        <div class="s-report-title d-flex justify-content-between">
                                            ...
                                            $count_today_visitors = $result['totaladult'];
                                            ?>
                                            <h3 class="header-title mb-0">Hoy visitante extranjero adulto</h3>
                                            <p style="font-size: 20px;color: red"><?php echo $count_today_visitors ?></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="single-report">
                                    <div class="s-sale-inner pt--30 mb-3">
                                        <div class="s-report-title d-flex justify-content-between">
                                            ...
                                            $count_today_cvisitors = $result['totalchild'];
                                            ?>
                                            <h4 class="header-title mb-0">Hoy visitante extranjero niño</h4>
                                            <p style="font-size: 20px;color: red"><?php echo $count_today_cvisitors ?></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="single-report">
                                    <div class="s-sale-inner pt--30 mb-3">
                                        <div class="s-report-title d-flex justify-content-between">
                                            ...
                                            $count_Yest_visitors = $result['totaladulty'];
                                            ?>
                                            <h4 class="header-title mb-0">Ayer visitante extranjero adulto</h4>
                                            <p style="font-size: 20px;color: red"><?php echo $count_Yest_visitors ?></p>
                                        </div>
                                    </div>
                                ...
                                <div class="single-report">
                                    <div class="s-sale-inner pt--30 mb-3">
                                        <div class="s-report-title d-flex justify-content-between">
                                            ...
                                            $count_Yest_cvisitors = $result['totalchildy'];
                                            ?>
                                            <h4 class="header-title mb-0">Ayer visitante extranjero niño</h4>
                                            <p style="font-size: 20px;color: red"><?php echo $count_Yest_cvisitors ?></p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <a href="grafics.php" class="btn btn-primary mt-2">Gráficos</a>

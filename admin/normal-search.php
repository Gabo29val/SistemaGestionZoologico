...
<head>
    ...
    <title>Buscar ticket normal - Sistema de Gestión de Zoológico</title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>Buscar por Ticket ID (ticket normal)</label>
...
$sdata=$_POST['searchdata'];
  ?>
  <h4 align="center">Resultado de ID "<?php echo $sdata;?>" (ticket normal) </h4>  

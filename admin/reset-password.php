...
<head>
    ...
    <title>Restablecer contraseña - Sistema de Gestión de Zoológico</title>
        ...
        <div class="container">
            <div class="login-box ptb--100">
                <form action="" method="post" name="changepassword" onsubmit="return checkpass();">
                        ...
                        <p>Hola, restablece tu contraseña</p>
                    </div>
                    <div class="login-form-body">
                        ...
                        <div class="submit-btn-area">
                            <button id="form_submit" type="submit" name="submit">Restablecer <i class="ti-arrow-right"></i></button>

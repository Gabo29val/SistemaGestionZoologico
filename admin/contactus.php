...
<head>
    ...
    <title>Contacta con nosotros - Sistema de Gestión de Zoológico</title>
                    ...
                    <div class="col-lg-12 col-ml-12">
                        <div class="row">
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Contacta con nosotros</h4>
...
?>
                                             <div class="form-group">
                                                <label for="exampleInputEmail1">Título de la página</label>
                                                <input type="text" class="form-control" name="pagetitle" value="<?php  echo $row['PageTitle'];?>" required='true'>
                                            </div>
                                         <div class="form-group">
                                                <label for="exampleInputEmail1">Descripción de la página</label>
